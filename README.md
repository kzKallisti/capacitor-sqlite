...
<p align="center"><strong><code>kzKallisti/capacitor-sqlite</code></strong></p>
<br>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/kzKallisti/capacitor-sqlite"><img src="https://img.shields.io/npm/l/kzKallisti/capacitor-sqlite?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/kzKallisti/capacitor-sqlite"><img src="https://img.shields.io/npm/dw/kzKallisti/capacitor-sqlite?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/kzKallisti/capacitor-sqlite"><img src="https://img.shields.io/npm/v/kzKallisti/capacitor-sqlite?style=flat-square" /></a>
...
| Maintainer      | GitHub                                      |
| --------------- | ------------------------------------------- |
| Kallisti.cash   | [kzKallisti](https://github.com/kaKallisti) |

To install:

```
npm install --save kzKallisti/capacitor-sqlite
npx cap sync
```

```
yarn add kzKallisti/capacitor-sqlite
npx cap sync
```
